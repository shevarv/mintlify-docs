---
title: Калькулятор бітів listdata
description: Інтерактивний калькулятор бітових реєстрів
---

import { useState } from "react";

/* ====== СТИЛІ (локальні, в цьому ж файлі) ====== */
<style>
{`
  .bit-calculator {
  max-width: 1200px;
  ...
  /* Фон сторінки */
  background: linear-gradient(180deg, #0a1633 0%, #0c1f4a 50%, #0a1633 100%);
  min-height: 100vh;
}
...
.bit-checkbox-wrapper:hover {
  background-color: rgba(255, 255, 255, 0.06);
  border-color: rgba(255, 255, 255, 0.12);
}

.bit-checkbox-wrapper input[type='checkbox'] {
  width: 18px;
  height: 18px;
  cursor: pointer;
  accent-color: #4f8cff;
